"""
Tests for SGLattice-based GIWAXS simulations.
"""
import pytest
import numpy as np
from pygidsim.giwaxs_sim import GIWAXSFromSGLattice


class TestGIWAXSFromSGLattice:
    """Test class for GIWAXSFromSGLattice functionality."""

    @pytest.fixture
    def xu_lattice(self, cif_file):
        """Create xrayutilities lattice from CIF file."""
        import xrayutilities as xu
        return xu.materials.Crystal.fromCIF(str(cif_file)).lattice

    def test_giwaxs_sim_random_orientation_with_mi(self, xu_lattice, exp_parameters):
        """Test GIWAXS simulation with random orientation and MI return."""
        el = GIWAXSFromSGLattice(xu_lattice, exp_parameters)
    ...
    def test_giwaxs_sim_specific_orientation_no_mi(self, xu_lattice, exp_parameters, random_orientation):
    ...
    def test_giwaxs_sim_powder_with_mi(self, xu_lattice, exp_parameters):
    ...
    def test_giwaxs_sim_powder_no_mi(self, xu_lattice, exp_parameters):
    ...
    def test_intensity_values_positive(self, xu_lattice, exp_parameters):
    ...
    def test_q_values_positive(self, xu_lattice, exp_parameters):
